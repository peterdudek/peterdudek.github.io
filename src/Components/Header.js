         ...
         <header id="home">
            ...
            <div className="row banner">
               <div className="banner-text">
                  ...
                  <h3>
                  A Certified Pega Senior System Architect leveraging project management and compliance background to build applications that meet business objectives and create the ultimate user experience.
                  </h3>
                  <hr />
                  <ul className="social">
                     {networks}
